...
<body>
	...
	<div class="container">
		<h1 class="col-sm-offset-2">팀 정보 등록</h1>
		<form class="form-horizontal" method="post" action="createProc.jsp">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">보유기술</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="sample6_postcode" name="zipcode" size="4" maxlength="5" />
				</div>
				<div class="col-sm-4">
